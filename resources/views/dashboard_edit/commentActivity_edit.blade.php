            ...
            <div class="col-lg-12">
                <div class="card-body ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/comment-activity/{{ $comment->id }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text"
                                        ...
                                        autocomplete="off" placeholder="Input Nama Kegiatan"
                                        value="{{ old('name') ? old('name') : $comment->name}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="email"
                                        ...
                                        value="{{ old('email') ? old('email') : $comment->email }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description"
                                        ...
                                        placeholder="Input Deskripsi">{{ old('description') ? old('description') : $comment->description }}</textarea>
