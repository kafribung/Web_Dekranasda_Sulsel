                        ...
                        <div class="card-body">
                            <form action="/activity/{{ $activity->id }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ url($activity->img) }}" alt="Error" title="Gambar {{ $activity->name }} " height="80" width="80">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror"  autocomplete="off" placeholder="Input Nama Kegiatan" value="{{old('name') ? old('name') : $activity->name }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="tgl" name="tgl" type="date" class="form-control @error('tgl') is-invalid @enderror"  value="{{old('tgl') ? old('tgl') : $activity->tgl }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" class="form-control ckeditor @error('description') is-invalid @enderror" placeholder="Input Deskripsi">{{ old('description') ? old('description') : $activity->description}}</textarea>
